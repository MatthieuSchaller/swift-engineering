 ...
 *
 ******************************************************************************/
#ifndef SWIFT_ENGINEERING_HYDRO_DEBUG_H
#define SWIFT_ENGINEERING_HYDRO_DEBUG_H
...
__attribute__((always_inline)) INLINE static void hydro_debug_particle(
  ...
  warning(
      ...
      p->a_hydro[0], p->a_hydro[1], p->a_hydro[2], p->mass,
      hydro_get_comoving_pressure(p), p->v_sig, p->h, p->density.wcount, p->rho,
...
#endif /* SWIFT_ENGINEERING_HYDRO_DEBUG_H */
